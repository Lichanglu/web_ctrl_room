...
#define SESSION_TIMEOUT 2*60 //2 minutes
...
extern cgiFormResultType cgiFormShort(char *name, short *result, short defaultV);
...
extern void cgiPageReplace(char* replaceUrl);
