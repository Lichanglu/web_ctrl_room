...
{
	ONE_MP   =  0x1,   //单画面
	TWO_MP_1 = 0x21,   //画面  一大一小（右上角）
	TWO_MP_2 = 0x22,   //2画面 一大一小（右下角）
	TWO_MP_3 = 0x23,   //  2画面  等分
	THREE_MP = 0x31,   //  3画面
	FOUR_MP  = 0x41,   //  4画面
	FIVE_MP  = 0x51,   //  5画面
...
char *GetSwitchString(int cmd)
{
	switch(cmd)
	{
		...
		case SWITCH_STUDENTS_PANORAMA:		//切换学生全景摄像机
			...
			break;
		//case SWITCH_TEACHER_PANORAMA:	//切换讲台摄像机全景
			//return "@@@@@ SWITCH_TEACHER_PANORAMA @@@@@";
		//	break;
		case SWITCH_2_VGA_TEATHER:      //VGA大 老师小
		...
		case	SWITCH_2_STUPANORAMA_TEATHER_1:
		    ...
		    break;
		case SWITCH_2_VGA_TEATHER_1:      //VGA大 老师小
			return "@@@@@ SWITCH_2_VGA_TEATHER_1 @@@@@";
		    break;
		case SWITCH_2_STU_TEATHER: //学生大 老师小
			return "@@@@@ SWITCH_2_STU_TEATHER @@@@@";
			break;
		case SWITCH_2_TEATHER_STU:       //老师大 学生小
			return "@@@@@ SWITCH_2_TEATHER_STU @@@@@";
			break;
		case SWITCH_2_TEATHER_AND_VGA:      //老师 VGA均等
			return "@@@@@ SWITCH_2_TEATHER_AND_VGA @@@@@";
			break;
		case   SWITCH_2_TEATHER_AND_STU:        //老师 学生均等
		...
		case	SWITCH_4_VGA_TEACHPANORAMA_STUPANORAMA_TEACHPANORAMA :  //板书大 学生全景
			...
			break;
		case	SWITCH_4_BLACKBOARD_TEATHER_STU_TEACHPANORAMA :  //板书大 学生全景
			return "@@@@@ SWITCH_4_BLACKBOARD_TEATHER_STU_TEACHPANORAMA @@@@@";
			break;
		case	SWITCH_4_BLACKBOARD_TEATHER_STUPANORAMA_TEACHPANORAMA :  //板书大 学生全景
			return "@@@@@ SWITCH_4_BLACKBOARD_TEATHER_STUPANORAMA_TEACHPANORAMA @@@@@";
			break;
		case	SWITCH_4_BLACKBOARD_TEACHPANORAMA_STU_TEACHPANORAMA :  //板书大 学生全景
			return "@@@@@ SWITCH_4_BLACKBOARD_TEACHPANORAMA_STU_TEACHPANORAMA @@@@@";
			break;
		case	SWITCH_4_BLACKBOARD_TEACHPANORAMA_STUPANORAMA_TEACHPANORAMA :  //板书大 学生全景
			return "@@@@@ SWITCH_4_BLACKBOARD_TEACHPANORAMA_STUPANORAMA_TEACHPANORAMA @@@@@";
			break;
		case	SWITCH_5    :
			return "@@@@@ SWITCH_5 @@@@@";
			break;
...
void SERVERTCP(void *Param)
{
	...
	while(1)
	{
		...
		if(cliSocket<0)
		{
			DEBUG(DL_DEBUG,"get a error server socket\n");
			break;
		}
...
Int32 GetCurSwitchCmd(MpState *pMpState)
{
	...
	{
		if(gStrategy == STRATEGY_5_1 || gStrategy == STRATEGY_5_2 )
		{
			if((pSubMp[0].CurSubMp == TEACHER_FAR_INDEX) && (pSubMp[1].CurSubMp == VGA_INDEX) && (pSubMp[2].CurSubMp == STUDENT_FAR_INDEX))
			{
				return SWITCH_4_VGA_TEATHER_STUPANORAMA_TEACHPANORAMA;
...
MpState *GetMpHand(UInt32 num)
{
	...
	else if((num == TWO_MP_1) || (num == TWO_MP_2) || (num == TWO_MP_3))
	{
		pMpState       = &TwoState;
	}
...
UInt32 SwitchPictureLayout(MpState *pMpState, TrackState *pTrackState)
{
	...
	LastSwitch     = pMpState->LastSwitch;
	...
	zlog_debug(ptrackzlog,"Strategy[%d] Num[%d] StudentUp[%d] StudentState[%d] [%d] TeacherState[%d] [%d] VgaState[%d] [%d]\n",\
	gStrategy,pMpState->num,StudentUp,pMpState->StudentState,pSubMp[2].Flag,pMpState->TeacherState,pSubMp[0].Flag,pMpState->VgaState,pSubMp[1].Flag);
...
//	printf("------------------------------------\n");
	if(CurSwitch != LastSwitch)
	{
		...
		{
			//teacherTracerMove(CurSwitch);
			pMpState->LastSwitch = CurSwitch;
...
int teacherTracerMove(unsigned short int data)
{
	...
	{
		data = SWITCH_2_VGA_TEATHER;
	}
	else if(aaa == 3)
	{
		data = SWITCH_3_VGA_TEATHER_STU;
	}
	else if(aaa == 4)
	{
		data = SWITCH_4_VGA_TEATHER_STU_TEACHPANORAMA;
	}
	else if(aaa == 6)
	{
		data = SWITCH_6_1;
	...
	{
		case SWITCH_TEATHER :		//切换老师机命令
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_TEATHER\n");
			break;
		case SWITCH_STUDENTS:		//切换学生机命令
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_STUDENTS\n");
			break;
		case SWITCH_VGA:						//切换VGA命令
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_VGA\n");
			break;
		case SWITCH_BLACKBOARD1:				//切换板书摄像机命令
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_BLACKBOARD\n");
			break;
		case SWITCH_STUDENTS_PANORAMA:		//切换学生全景摄像机
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_STUDENTS_PANORAMA\n");
			break;
		case SWITCH_TEACHER_PANORAMA:	//切换讲台摄像机全景
			printf("1@@@@@@@@@@@@@@@@@ SWITCH_TEACHER_PANORAMA or SWITCH_BLACKBOARD2\n");
			break;
		default:
				//return 0;
			break;
